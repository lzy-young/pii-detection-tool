...
- PERSON: People's Names (first and last names, including initials).
...
- CATEGORY LABELS: PERSON, NORP, GPE, FAC, ORG, LOC
- You can ONLY USE the CATEGORY LABELS provided above to label the extracted information. 
- DO NOT make up any information and ONLY extract what is explicitly present in the INPUT provided below
- If there is no PII information in the INPUT text, you MUST STOP and output: {{"message": "No PII detected"}}
- Use this format: {{"value": "extracted_text", "label": "CATEGORY", "start": position, "end": position}} to output each extracted entity
- Try to UNDERSTAND the CATEGORIES EXPLANATION section to improve your extraction accuracy
======================================================================================
EXAMPLE1:
INPUT: <B> "The fiery Bowa helped lead the Phillies to the franchise 's only World Series Championship in 1980 , as a player .\
        She was a Russian player, and her hometown is Moscow. the detail of address is Red Square , Moscow . She visited the White House." <E>
OUTPUT:
{{"value": "Bowa", "label": "PERSON", "start": 2, "end": 3}}
{{"value": "Phillies", "label": "ORG", "start": 6, "end": 7}}
{{"value": "Russian", "label": "NORP", "start": 39, "end": 40}}
{{"value": "Moscow", "label": "GPE", "start": 40, "end": 47}}
{{"value": "Red Square", "label": "LOC", "start": 61, "end": 72}}
{{"value": "White House", "label": "FAC", "start": 80, "end": 91}}
<END>
=======================================================================================
EXAMPLE2:
INPUT: <B> "I have 2 apples. And they are worth 5 dollars." <E>
OUTPUT:
{{"message": "No PII detected"}}
<END>
=======================================================================================
EXAMPLE3:
INPUT: <B> "UNESCO's foundation was in 1945 is a specialized agency of the United Nations (UN) based in Paris." <E>
OUTPUT:
{{"value": "UNESCO", "label": "ORG", "start": 0, "end": 6}}
{{"value": "United Nations", "label": "ORG", "start": 50, "end": 65}}
{{"value": "Paris", "label": "GPE", "start": 80, "end": 85}}
<END>
======================================================================================
INPUT:
<B> {text} <E>
...
if __name__ == "__main__":
    ...
    temperature=0,
    max_tokens=1024,
    stop=["\n\n\n","###","```","python","<END>","EXAMPLE","INSTRUCTIONS:","TASK","INPUT:","OUTPUT:","def","import"],
    n=1
    )
